<div class="row margin-top-10 step-1">
	...
	<div class="col-sm-6 text-center">
		...
		<img style="max-width: 50%; display: inline;" class="img-responsive" src="<?php echo base_url() ?>application/modules/settings/assets/img/maintenance/4axis/a_mode.png">
	...
	<div class="col-sm-6">
		...
		<p class="text-center"><a href="javascript:void(0);" class="btn btn-primary btn-default btn-lg do-engage"> Start </a></p>
